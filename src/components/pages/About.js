...
function About() {
  ...
  <div className="aboutBackground">
    <div className="bio">
      I am a senior at Santa Clara University majoring in Computer Science and minoring in Mathematics at
      ...
      studying for my masters in Computer Science and Engineering.<br/>
      <br/>
      ...
      <br/>
      Relevant Courses Include: Object-Oriented Programming,
